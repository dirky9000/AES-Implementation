...
// Data Input                       |   output dout
// 127:120  95:88   63:56   31:24   | 127:120  95:88   63:56    31:24
// 119:112  87:80   55:48   23:16   | 87:80    55:48   23:16    119:112
// 111:104  79:72   47:40   15:8    | 47:40    15:8    111:104  79:72
// 103:96   71:64   39:32   7:0     | 7:0      103:96  71:64    39:32
...
begin
    if(reset)
        ...
        dout[119:112]<= data[87:80]; 
        dout[111:104]<= data[47:40]; 
        dout[103:96] <= data[7:0]; 
        
        dout[95:88]  <= data[95:88]; 
        dout[87:80]  <= data[55:48]; 
        dout[79:72]  <= data[15:8]; 
        dout[71:64]  <= data[103:96]; 
        
        dout[63:56]  <= data[63:56]; 
        dout[55:48]  <= data[23:16]; 
        dout[47:40]  <= data[111:104]; 
        dout[39:32]  <= data[71:64]; 
        
        dout[31:24]  <= data[31:24]; 
        dout[23:16]  <= data[119:112]; 
