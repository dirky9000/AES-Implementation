...
HD_PWD='C:/Users/Alex/Desktop/Fall 2023 Class stuff/Cyber Security/AES/AES-Implementation/src/project_v2/project_v2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AESencrypt.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AESencrypt.tcl
